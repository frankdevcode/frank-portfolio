...
// import React, { useState } from 'react'; comentado para prueba por useEffect
  ...
  return (
    <div className='main-container-contact'>
      ...
      <div className='contact-paragraph-container'>
        <p className='contact-paragraph'>¡Gracias por tu interés en conectarte! Estoy emocionado por la posibilidad de colaborar contigo o responder a cualquier pregunta que puedas tener. Aquí tienes varias formas de ponerte en contacto conmigo:</p>
      </div>
      ...
      <div className='contact-form-main-container'>
        ...
        <div className='container-column-two-form'>
          ...
          <div className='container-title-column-two'>
            <p className='paragraph-column-two'>Mi compromiso es responder a tus consultas en el menor tiempo posible. Sin embargo, ten en cuenta que mi horario de disponibilidad puede variar debido a compromisos profesionales. Generalmente, puedes esperar una respuesta dentro de las 24 horas hábiles.</p>
          </div>
        </div>
      </div>
      ...
      <div className=''>
        ...
        <div className=''>
          <p className='paragraph-column-two'>Si estás interesado en explorar oportunidades de colaboración, contratación o proyectos conjuntos, estaré encantado de discutir cómo puedo contribuir a tus objetivos. Por favor, proporciona detalles adicionales en tu mensaje para que pueda entender mejor tus necesidades.</p>
        </div>
      </div>

      
      <div className='container-title-column-two'>
        <p className='paragraph-column-two'></p>
      </div>
